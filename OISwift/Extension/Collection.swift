...
public class CollectionView: UICollectionView {
    ...
    @discardableResult
    func reload() -> CollectionView {
        self.reloadData()
        return self
    }

    @discardableResult
    func delegate(_ delegate: UICollectionViewDelegate) -> CollectionView {
        self.delegate = delegate
        return self
    }

    @discardableResult
    func dataSource(_ dataSource: UICollectionViewDataSource) -> CollectionView {
        self.dataSource = dataSource
        return self
    }

    @discardableResult
    func register(cell: AnyClass, id: String) -> CollectionView {
        self.register(cell, forCellWithReuseIdentifier: id)
        return self
    }

    @discardableResult
    func register(cell: AnyClass?, elementKind: String, id: String) -> CollectionView {
        self.register(cell, forSupplementaryViewOfKind: elementKind, withReuseIdentifier: id)
        return self
    }

    @discardableResult
    func showsHorizontalScrollIndicator(_ value: Bool) -> CollectionView {
        self.showsHorizontalScrollIndicator = value
        return self
    }

    @discardableResult
    func showsVerticalScrollIndicator(_ value: Bool) -> CollectionView {
        self.showsVerticalScrollIndicator = value
        return self
    }

    @discardableResult
    func isScrollEnabled(_ value: Bool) -> CollectionView {
        self.isScrollEnabled = value
        return self
    }

    @discardableResult
    func allowsSelection(_ value: Bool) -> CollectionView {
        self.allowsSelection = value
        return self
    }

    @discardableResult
    func allowsMultipleSelection(_ value: Bool) -> CollectionView {
        self.allowsMultipleSelection = value
        return self
    }

    @discardableResult
    func contentInset(_ value: UIEdgeInsets) -> CollectionView {
        self.contentInset = value
        return self
    }

    @discardableResult
    func scrollIndicatorInsets(_ value: UIEdgeInsets) -> CollectionView {
        self.scrollIndicatorInsets = value
        return self
    }

    @discardableResult
    func alwaysBounceVertical(_ value: Bool) -> CollectionView {
        self.alwaysBounceVertical = value
        return self
    }

    @discardableResult
    func alwaysBounceHorizontal(_ value: Bool) -> CollectionView {
        self.alwaysBounceHorizontal = value
        return self
    }

    @discardableResult
    func contentSize(_ value: CGSize) -> CollectionView {
        self.contentSize = value
        return self
    }

    @discardableResult
    func contentOffset(_ value: CGPoint) -> CollectionView {
        self.contentOffset = value
        return self
    }

    @discardableResult
    func didSelectItemAt(_ closure: @escaping (UICollectionView, IndexPath) -> Void) -> CollectionView {
    ...
    @discardableResult
    func didDeselectItemAt(_ closure: @escaping (UICollectionView, IndexPath) -> Void) -> CollectionView {
        self.delegate = self
    ...
    @discardableResult
    func willDisplay(_ closure: @escaping (UICollectionView, UICollectionViewCell, IndexPath) -> Void) -> CollectionView {
        self.delegate = self
    ...
    @discardableResult
    func didEndDisplaying(_ closure: @escaping (UICollectionView, UICollectionViewCell, IndexPath) -> Void) -> CollectionView {
        self.delegate = self
    ...
    @discardableResult
    func didHighlightItemAt(_ closure: @escaping (UICollectionView, IndexPath) -> Void) -> CollectionView {
        self.delegate = self
    ...
    @discardableResult
    func didUnhighlightItemAt(_ closure: @escaping (UICollectionView, IndexPath) -> Void) -> CollectionView {
        self.delegate = self
    ...
    @discardableResult
    func sizeForItemAt(_ closure: @escaping (UICollectionView, UICollectionViewLayout, IndexPath) -> CGSize) -> CollectionView {
        self.delegate = self
    ...
    @discardableResult
    func insetForSectionAt(_ closure: @escaping (UICollectionView, UICollectionViewLayout, Int) -> UIEdgeInsets) -> CollectionView {
        self.delegate = self
    ...
    @discardableResult
    func spacingCell(_ closure: @escaping (UICollectionView, UICollectionViewLayout, Int) -> CGFloat) -> CollectionView {
        self.delegate = self
    ...
    @discardableResult
    func minimumLineSpacingForSectionAt(_ closure: @escaping (UICollectionView, UICollectionViewLayout, Int) -> CGFloat) -> CollectionView {
        self.delegate = self
        self.minimumLineSpacingForSectionHandler = closure // Adding minimumLineSpacingForSectionAt handler closure
        return self
    }
    ...
    @discardableResult
    func minimumInteritemSpacingForSectionAt(_ closure: @escaping (UICollectionView, UICollectionViewLayout, Int) -> CGFloat) -> CollectionView {
        self.delegate = self
    ...
    @discardableResult
    func referenceSizeForHeaderInSection(_ closure: @escaping (UICollectionView, UICollectionViewLayout, Int) -> CGSize) -> CollectionView {
        self.delegate = self
    ...
    @discardableResult
    func viewForSupplementaryElementOfKind(_ closure: @escaping (UICollectionView, String, IndexPath) -> UICollectionReusableView) -> CollectionView {
        self.delegate = self
